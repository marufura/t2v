...
class T2V(object):
    ...
    def replace_text_all(self, text):
        ...
        for replacement_set in self.user_dictionary:
    ...
    def generate_voice(self, text):
        ...
        read_text = self.replace_text_all(text)
...
if __name__ == '__main__':
    ...
    my_dict = json.loads(config_ini['General']['USER_DICTIONARY'])

    t2v = T2V(api_key=voiceText_api_key, api_endpoint=voiceText_api_endpoint, user_dictionary=my_dict)
    t2v.generate_voice(
